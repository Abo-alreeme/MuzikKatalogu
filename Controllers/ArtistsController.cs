...
namespace MuzikKatalogu.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(MuzikKataloguDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Sanatçıyı ve ilişkili albümlerini yüklüyoruz.
            var artist = await _context.Artists
                .Include(a => a.Albums) // Sanatçıya ait albümleri yüklemek için
